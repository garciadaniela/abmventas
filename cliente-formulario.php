...
if (isset($_GET["do"]) && $_GET["do"] == "buscarLocalidad") {
  ...
  $aLocalidad = $localidad->obtenerPorId($idProvincia);
              ...
              <div class="col-12">    
                   <div class="card mb-3">
                  ...
                         <div class="panel-body">
                    <table id="grilla" class="display pl-3" style="width:98%">
                      <thead>
                        <tr>
                          <th>Tipo</th>
                          <th>Provincia</th>
              ...
              <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                      <button type="button" onclick="fAgregarDomicilio()" class="btn btn-primary">Agregar</button>
                    </div>
                  </div>
                </div>
              </div>
